<template>
  <details class="group">
    ...
    <div class="mt-3 grid grid-cols-[1fr_1.15fr] gap-4 rounded-md border border-border/70 bg-slate-950/20 p-3 max-lg:grid-cols-1">
      <div>
        <div class="mb-2 text-[11px] font-black uppercase text-muted-foreground">Sectors</div>
      ...
      <div>
        <div class="mb-2 text-[11px] font-black uppercase text-muted-foreground">Companies</div>
        <div class="flex flex-wrap gap-2">
          <span
    ...
    <section class="mt-3">
      <div class="mb-2 text-[11px] font-black uppercase text-muted-foreground">Reasoning</div>
